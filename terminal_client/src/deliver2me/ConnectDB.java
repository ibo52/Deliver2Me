...
public class ConnectDB {
    ...
    public class user{
        ...
        public user(String email){
            ...
            String Query="SELECT customer_id,city_id FROM public.\"customer\""
                + " WHERE email=\'"+email+"\'";
        ...
        public void getRestaurantsPopularity(){
            ...
            System.out.println("--------------------------------------\n"
                             + "POPULARITY OF RESTAURANTS NEAR "+cityQuery
                             + "\n--------------------------------------");
            printQueryResults(rs);
        }
    ...
    private int updateDB(String query_string){
